...
/**
 * Tipografía personalizada para la aplicación de clínica veterinaria
 * Diseño moderno inspirado en apps de pet care contemporáneas
 */
val Typography = Typography(
    ...
    // Body styles - Para texto general
    bodyLarge = TextStyle(
        fontFamily = FontFamily.Default,
